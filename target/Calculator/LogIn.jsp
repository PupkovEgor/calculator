...
<br><label for="first" >Логин: </label>
...
<br><input type="submit" name="sign" value="Вычислить"></br>
<br><input type="button" name="gtreg" value="Регистрация" onclick="location.href='Text/Text.txt'"></br>
<p>${result}</p>
</form>
</div>
</body>
