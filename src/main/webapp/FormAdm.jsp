...
table {
  ...
  <div style="position: relative; align:center; display:inline-table;">
    <table width=auto height=auto cellspacing="0" cellpadding="5" cols = "4" style="display: inline-table;">
      ...
      <tr>
        <td colspan="2"><p align="left"  class="text">Длина:</p>
        </td>
        <td colspan="2">
          <p align="left" class="text">Ширина:</p>
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        <td colspan="2"><p align="left" class="text">Высота:</p>
        </td>
        <td colspan="2"><p align="left" class="text">Количество этажей:</p>
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        <td colspan="2">
          <p align="left" class="text">Срочный заказ:<input type="checkbox"  name="order" value= "${order}"></p>
        </td>
        <td colspan="2">
      ...
      <tr>
        <td colspan="2">
          <p align="left" class="text">Промокод:</p>
        </td>
        <td colspan="2">
      ...
      <tr>
        <td colspan="2">
          <p align="left"> 
            <input type="submit" name="calculation" value="Расчет " class="combo" style="font-size : 13pt;" >
          </p> 
        </td>
        <td colspan="2">
         <p align="left">
          ...
          <input type="button" value=" Информация " class="combo" id="example_2_2" onclick=" document.getElementById('okno').style.display='none'; document.getElementById('example_2_2').style.display='none'; document.getElementById('info').style.display='block';" style=" font-size : 13pt; display:none;">
        </p>
        </td>
      </tr>
  </form>
  <form action="${pageContext.request.contextPath}/Admin" method="post">   
      <tr>
        <td colspan="2">
          <p align="left"> 
            <input id="settings" type="button" name="settings" value="Смена настроек " class="combo" style="font-size : 13pt;" onclick="location.hash ='dop'" >
          </p> 
        </td>
        <td colspan="2">
          <p align="left">
            <input type="button" name="exit" value="Выход из аккаунта" onclick="location.href='LogIn.jsp'" class="combo" style="font-size : 13pt;">
        </td>
      </tr>
    </table>
  <div id="dop" class="okno" style="font-size : 14pt; color: #b3b3b3; " >
    <table>
      <tr>
        <td>
          <div align="right" style="position:static;">
            <a href="#" style="text-decoration: none;text-align: right; color:#b3b3b3;">&#215;</a>
          </div>
        </td>
      </tr>
      <tr>
        <td style="height:60px;">
          <p style="text-align:left;"  class="text">Вид дома для изменения:<br>
            <select name="type" value= "${type}" class="combo">
              <option value="1">Летний дом</option>
              <option value="2">Зимний дом</option>
              <option value="3">Сброс "Летний"</option>
              <option value="4">Сброс "Зимний"</option>
            </select>
          </p>
        </td>
      </tr>   
      ...
      <tr>
        <td style="height:60px;"><p align="left" class="text">Количество этажей:<br>
          <input type="number" min="1" max="3" name="floor"  value= "${floor}" size="20"class="combo" style="width: 203px"></p>
        </td>
      </tr>
      <tr>
        <td style="height:60px;">
          <p align="left" class="text">Внутренняя отделка:<br>
            <select name="otdelka" value= "${otdelka}" class="combo">
              <option value="1">Heт </option>
              <option value="2">Чepнoвaя</option>
              <option value="3">Под ключ</option>
            </select>
      ...
      <tr>
        <td style="height:60px;">
          <p align="left"> 
            <input type="submit" name="ready" value="Применить настройки" class="combo" style="font-size : 13pt;">
          </p>
        </td>
      </tr>
    </table>
